const messages = {
  ...
  "builder.fields.ageBand": "Przedział wiekowy dziecka",
  "builder.options.chooseAgeBand": "Wybierz przedział wiekowy",
  "builder.options.ageBand3to5": "3–5 lat",
  "builder.options.ageBand6to8": "6–8 lat",
  "builder.options.ageBand9to12": "9–12 lat",
  ...
  "builder.options.chooseInterest": "Wybierz zainteresowanie",
  "builder.interests.stars": "Gwiazdy i kosmos",
  "builder.interests.animals": "Zwierzęta",
  "builder.interests.dinosaurs": "Dinozaury",
  "builder.interests.nature": "Przyroda",
  "builder.interests.trains": "Pociągi",
  "builder.interests.robots": "Roboty",
  "builder.interests.music": "Muzyka",
  "builder.interests.art": "Sztuka",
  ...
  "form.error.unsupportedLanguagePair": "Zachowaliśmy wybrane języki. Wybierz obecnie dostępną kombinację języków.",
  "form.error.unsupportedInterest": "To zapisane zainteresowanie nie jest jeszcze dostępne dla bajek AI. Wybierz aktualną opcję.",
  "form.error.unsupportedAgeBand": "Ten zapisany przedział wiekowy wykracza poza obecny zakres bajek. Wybierz obsługiwany przedział.",
  "list.and": "i",
  ...
  "story.state.loading": "Milo tworzy i sprawdza bajkę. To może chwilę potrwać.",
  ...
  "story.error.providerUnavailable": "Generowanie bajek jest chwilowo niedostępne. Spróbuj ponownie za chwilę.",
  "story.error.qualityBlock": "MoonTale nie utworzyło bajki spełniającej wymagania jakości. Spróbuj ponownie.",
  "story.error.unsuitableDetails": "MoonTale nie mogło utworzyć odpowiedniej bajki z tych szczegółów. Zmień wybrane ustawienia.",
  "story.error.generationFailure": "MoonTale nie mogło ukończyć tej bajki. Spróbuj ponownie.",
  "story.state.retry": "Spróbuj ponownie",
  "builder.localProvider.authorization": "Tryb testowy z prawdziwym dostawcą wysyła do Groq tylko wybrany przedział wiekowy, kontrolowane zainteresowanie, ustawienia bajki i identyfikatory słownictwa. Nie wysyła pseudonimu ani dokładnego wieku. Używaj wyłącznie fikcyjnych, niewrażliwych danych testowych."
};
