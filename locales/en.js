const messages = {
  ...
  "builder.fields.ageBand": "Child's age range",
  "builder.options.chooseAgeBand": "Choose age range",
  "builder.options.ageBand3to5": "3–5 years old",
  "builder.options.ageBand6to8": "6–8 years old",
  "builder.options.ageBand9to12": "9–12 years old",
  ...
  "builder.options.chooseInterest": "Choose an interest",
  "builder.interests.stars": "Stars and space",
  "builder.interests.animals": "Animals",
  "builder.interests.dinosaurs": "Dinosaurs",
  "builder.interests.nature": "Nature",
  "builder.interests.trains": "Trains",
  "builder.interests.robots": "Robots",
  "builder.interests.music": "Music",
  ...
  "builder.footer.note": "Made for calm family moments. Story details are handled as described in the Privacy Policy.",
  ...
  "form.error.unsupportedLanguagePair": "Keep your selected languages, then choose a currently available language combination.",
  "form.error.unsupportedInterest": "This saved interest is not available for AI stories yet. Please choose a current option.",
  "form.error.unsupportedAgeBand": "This saved age range is outside the current story scope. Please choose a supported range.",
  "list.and": "and",
  ...
  "story.state.loading": "Milo is creating and checking your story. This can take a little while.",
  "story.state.errorTitle": "This story is not ready yet",
  "story.state.error": "MoonTale could not finish this story safely. Please try again.",
  "story.error.invalidConfiguration": "Some story details need to be corrected before MoonTale can generate this story.",
  "story.error.pilotAuthorizationRequired": "Sign in to a parent account to create stories in the MoonTale private pilot.",
  "story.error.pilotAccessDenied": "This parent account is not currently enabled for MoonTale private-pilot story generation.",
  "story.error.unsupportedLanguagePair": "This language combination isn't available for story generation yet.",
  "story.error.providerRateLimit": "MoonTale is preparing many stories right now. Please try again shortly.",
  "story.error.providerTimeout": "The story took too long to prepare. Please try again.",
  "story.error.providerUnavailable": "Story generation is temporarily unavailable. Please try again shortly.",
  "story.error.qualityBlock": "MoonTale couldn't produce a story that met its quality checks. Please try again.",
  "story.error.unsuitableDetails": "MoonTale couldn't create a suitable story from these details. Please adjust the story choices.",
  "story.error.generationFailure": "MoonTale couldn't finish this story. Please try again.",
  "story.state.retry": "Try again",
  "builder.localProvider.authorization": "Real-provider test mode sends only the selected age range, controlled interest, story settings, and vocabulary IDs to Groq. It does not send the nickname or exact age. Use fictional, non-sensitive test details only."
};
