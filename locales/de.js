const messages = {
  ...
  "builder.fields.ageBand": "Altersgruppe des Kindes",
  "builder.options.chooseAgeBand": "Altersgruppe wählen",
  "builder.options.ageBand3to5": "3–5 Jahre",
  "builder.options.ageBand6to8": "6–8 Jahre",
  "builder.options.ageBand9to12": "9–12 Jahre",
  ...
  "builder.options.chooseInterest": "Interesse wählen",
  "builder.interests.stars": "Sterne und Weltraum",
  "builder.interests.animals": "Tiere",
  "builder.interests.dinosaurs": "Dinosaurier",
  "builder.interests.nature": "Natur",
  "builder.interests.trains": "Züge",
  "builder.interests.robots": "Roboter",
  "builder.interests.music": "Musik",
  "builder.interests.art": "Kunst",
  ...
  "form.error.unsupportedLanguagePair": "Die ausgewählten Sprachen wurden beibehalten. Wähle eine derzeit verfügbare Sprachkombination.",
  "form.error.unsupportedInterest": "Dieses gespeicherte Interesse ist für KI-Geschichten noch nicht verfügbar. Wähle eine aktuelle Option.",
  "form.error.unsupportedAgeBand": "Diese gespeicherte Altersgruppe liegt außerhalb des aktuellen Umfangs. Wähle eine unterstützte Gruppe.",
  "list.and": "und",
  ...
  "story.state.loading": "Milo erstellt und prüft eure Geschichte. Das kann einen Moment dauern.",
  ...
  "story.error.providerUnavailable": "Die Geschichtenerstellung ist vorübergehend nicht verfügbar. Versuche es in Kürze erneut.",
  "story.error.qualityBlock": "MoonTale konnte keine Geschichte erstellen, die die Qualitätsprüfungen bestanden hat. Versuche es erneut.",
  "story.error.unsuitableDetails": "MoonTale konnte aus diesen Angaben keine passende Geschichte erstellen. Passe die Auswahl an.",
  "story.error.generationFailure": "MoonTale konnte diese Geschichte nicht fertigstellen. Versuche es erneut.",
  "story.state.retry": "Erneut versuchen",
  "builder.localProvider.authorization": "Der Testmodus mit echtem Anbieter sendet nur die ausgewählte Altersgruppe, ein kontrolliertes Interesse, Story-Einstellungen und Wortschatz-IDs an Groq. Spitzname und genaues Alter werden nicht gesendet. Verwende nur erfundene, nicht sensible Testdaten."
};
