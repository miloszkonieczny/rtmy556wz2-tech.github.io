const messages = {
  ...
  "builder.fields.ageBand": "Rango de edad del niño",
  "builder.options.chooseAgeBand": "Elegir rango de edad",
  "builder.options.ageBand3to5": "3–5 años",
  "builder.options.ageBand6to8": "6–8 años",
  "builder.options.ageBand9to12": "9–12 años",
  ...
  "builder.options.chooseInterest": "Elegir un interés",
  "builder.interests.stars": "Estrellas y espacio",
  "builder.interests.animals": "Animales",
  "builder.interests.dinosaurs": "Dinosaurios",
  "builder.interests.nature": "Naturaleza",
  "builder.interests.trains": "Trenes",
  "builder.interests.robots": "Robots",
  "builder.interests.music": "Música",
  "builder.interests.art": "Arte",
  ...
  "form.error.unsupportedLanguagePair": "Conservamos los idiomas elegidos. Selecciona una combinación disponible actualmente.",
  "form.error.unsupportedInterest": "Este interés guardado aún no está disponible para cuentos con IA. Elige una opción actual.",
  "form.error.unsupportedAgeBand": "Este rango de edad guardado está fuera del alcance actual. Elige un rango compatible.",
  "list.and": "y",
  ...
  "story.state.loading": "Milo está creando y revisando tu cuento. Puede tardar un poco.",
  "story.state.errorTitle": "Este cuento aún no está listo",
  "story.state.error": "MoonTale no pudo terminar este cuento de forma segura. Inténtalo de nuevo.",
  "story.error.invalidConfiguration": "Hay que corregir algunos detalles antes de que MoonTale pueda generar este cuento.",
  "story.error.pilotAuthorizationRequired": "Inicia sesión en una cuenta de padre, madre o tutor para crear historias en el piloto privado de MoonTale.",
  "story.error.pilotAccessDenied": "Esta cuenta de padre, madre o tutor no tiene actualmente habilitada la generación de historias del piloto privado de MoonTale.",
  "story.error.unsupportedLanguagePair": "Esta combinación de idiomas todavía no está disponible para generar cuentos.",
  "story.error.providerRateLimit": "MoonTale está preparando muchos cuentos ahora. Inténtalo de nuevo en breve.",
  "story.error.providerTimeout": "El cuento tardó demasiado en prepararse. Inténtalo de nuevo.",
  "story.error.providerUnavailable": "La generación de cuentos no está disponible temporalmente. Inténtalo de nuevo en breve.",
  "story.error.qualityBlock": "MoonTale no pudo crear un cuento que superara sus controles de calidad. Inténtalo de nuevo.",
  "story.error.unsuitableDetails": "MoonTale no pudo crear un cuento adecuado con estos detalles. Ajusta las opciones del cuento.",
  "story.error.generationFailure": "MoonTale no pudo terminar este cuento. Inténtalo de nuevo.",
  "story.state.retry": "Intentar de nuevo",
  "builder.localProvider.authorization": "El modo de prueba con proveedor real envía a Groq únicamente el rango de edad seleccionado, un interés controlado, la configuración del cuento y los identificadores de vocabulario. No envía el apodo ni la edad exacta. Usa solo datos de prueba ficticios y no sensibles."
};
