const messages = {
  ...
  "builder.fields.ageBand": "Tranche d’âge de l’enfant",
  "builder.options.chooseAgeBand": "Choisir une tranche d’âge",
  "builder.options.ageBand3to5": "3–5 ans",
  "builder.options.ageBand6to8": "6–8 ans",
  "builder.options.ageBand9to12": "9–12 ans",
  ...
  "builder.options.chooseInterest": "Choisir un centre d’intérêt",
  "builder.interests.stars": "Étoiles et espace",
  "builder.interests.animals": "Animaux",
  "builder.interests.dinosaurs": "Dinosaures",
  "builder.interests.nature": "Nature",
  "builder.interests.trains": "Trains",
  "builder.interests.robots": "Robots",
  "builder.interests.music": "Musique",
  "builder.interests.art": "Art",
  ...
  "builder.footer.note": "Créé pour des moments familiaux calmes. Les données de l’histoire sont traitées comme décrit dans la Politique de confidentialité.",
  ...
  "form.error.unsupportedLanguagePair": "Vos langues ont été conservées. Choisissez une combinaison actuellement disponible.",
  "form.error.unsupportedInterest": "Ce centre d’intérêt enregistré n’est pas encore disponible pour les histoires IA. Choisissez une option actuelle.",
  "form.error.unsupportedAgeBand": "Cette tranche d’âge enregistrée dépasse le périmètre actuel. Choisissez une tranche prise en charge.",
  "list.and": "et",
  ...
  "story.state.loading": "Milo crée et vérifie votre histoire. Cela peut prendre un petit moment.",
  "story.state.errorTitle": "Cette histoire n'est pas encore prête",
  "story.state.error": "MoonTale n'a pas pu terminer cette histoire en toute sécurité. Réessayez.",
  "story.error.invalidConfiguration": "Certains détails doivent être corrigés avant que MoonTale puisse générer cette histoire.",
  "story.error.pilotAuthorizationRequired": "Connectez-vous à un compte parent pour créer des histoires dans le pilote privé MoonTale.",
  "story.error.pilotAccessDenied": "Ce compte parent n'est actuellement pas autorisé à générer des histoires dans le pilote privé MoonTale.",
  "story.error.unsupportedLanguagePair": "Cette combinaison de langues n’est pas encore disponible pour la génération d’histoires.",
  "story.error.providerRateLimit": "MoonTale prépare beaucoup d’histoires en ce moment. Réessayez bientôt.",
  "story.error.providerTimeout": "La préparation de l’histoire a pris trop de temps. Réessayez.",
  "story.error.providerUnavailable": "La génération d’histoires est temporairement indisponible. Réessayez bientôt.",
  "story.error.qualityBlock": "MoonTale n’a pas pu produire une histoire conforme à ses contrôles de qualité. Réessayez.",
  "story.error.unsuitableDetails": "MoonTale n’a pas pu créer une histoire adaptée avec ces détails. Modifiez les choix de l’histoire.",
  "story.error.generationFailure": "MoonTale n’a pas pu terminer cette histoire. Réessayez.",
  "story.state.retry": "Réessayer",
  "builder.localProvider.authorization": "Le mode de test avec le fournisseur réel envoie à Groq uniquement la tranche d’âge choisie, un centre d’intérêt contrôlé, les réglages de l’histoire et les identifiants de vocabulaire. Il n’envoie ni pseudonyme ni âge exact. Utilisez uniquement des données de test fictives et non sensibles."
};
